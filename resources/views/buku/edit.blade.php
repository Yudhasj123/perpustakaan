                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="kategori_id">
                                    ...
                                    <option value="{{ $ktg->id }}" {{ $ktg->id == $buku->ktg_id ? 'selected' : '' }}>{{ $ktg->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <br>
                                <img src="{{asset('/storage/buku/'.$buku->gambar)}}" alt="{{asset('/storage/buku/'.$buku->gambar)}}" style="width: 150px" class="rounded" >
                                {{-- <br></br> --}}
                                <input type="file" class="form-control" name="gambar" value="{{$buku->gambar}}">
                            </div>
                        </div>
                    </div>
